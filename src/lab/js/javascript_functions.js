...
function deleteTopicConfirm(formName,topicId,topicName)
{
	topicName=topicName.replace(/abc039;/g,"'").replace(/abcquot;/g,'"')
	var answer = confirm ("This will delete the lab '"+topicName+"' .Are you sure, you want to proceed?")
	if(answer)
	{
...
function deleteSubConfirm(formName,subjectId,subjectName)
{
	...
	var answer = confirm ("This will delete the Broad Area '"+subjectName+"' .Are you sure, you want to proceed?")
	if(answer)
	{
...
function checkPage(buttonName)
{
	...
	{
		var pageName=document.getElementById('addPageName');
		if(pageName.value=="")
		{
